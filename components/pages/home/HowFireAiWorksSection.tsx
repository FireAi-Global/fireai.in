    ...
    >
      <div className="flex flex-col lg:flex-row justify-between items-center lg:items-start mb-10 gap-6">
        <div className="w-full lg:w-fit text-center lg:text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 rounded-full mb-4 mx-auto lg:mx-0 shadow-sm">
      ...
      <div className="lg:hidden">
        <div className="text-center w-full max-w-[320px] mx-auto rounded-[20px] relative overflow-hidden" style={{ height: 380 }}>
          ...
          <div className="flex gap-2">
            {cards.map((_, index) => (
              <button
                ...
                className={`h-2 rounded-full cursor-pointer transition-all duration-300 ${index === currentSlide ? "w-8 bg-[#2B4EE7]" : "w-2 bg-[#E5E7EB] hover:bg-gray-300"}`}
              />
            ))}
          </div>
