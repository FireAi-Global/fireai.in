	...
	return (
		...
		>
			...
			<div className="mb-8 sm:mb-10 md:mb-12 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
				<div>
					<div className="inline-flex items-center gap-2 py-1.5 sm:py-2 rounded-full mb-4 sm:mb-6">
					...
					<h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-medium leading-tight">
						Simplifying{" "}
						<span className="bg-gradient-to-r from-[#0600A3] via-[#322638] to-[#0169FD] text-transparent bg-clip-text">
							Complex Data
						</span>{" "}
					...
					>
						<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
								...
								fill="url(#paint0_linear_1195_284)"
							/>
							<defs>
								<linearGradient
									id="paint0_linear_1195_284"
									x1="15.9986"
									y1="8.00098"
									x2="-0.000205996"
									y2="8.00098"
				...
				<div className="flex gap-2">
					{slides.map((_, index) => (
						<button
							...
							className={`h-2 rounded-full cursor-pointer transition-all duration-500 ease-in-out transform ${
								index === currentSlide
