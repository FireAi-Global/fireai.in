...
const Privacy: Component = () => {
  return (
    <div class="max-w-[1200px] mx-auto px-4 py-10 pt-24">
      <h1 class="text-3xl font-bold mb-8 pt-10">Privacy Policy</h1>
      
      <p class="mb-6">
        <span class="font-medium">Effective Date: March 14, 2024</span>
      </p>
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">2. About This Policy</h2>
        <p class="mb-4">This Privacy Policy applies to Fire AI's services, including its website and any related tools. It outlines:</p>
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">3. Data We Collect</h2>
        <p class="mb-4">Fire AI collects different types of personal data based on how you use our services. This includes:</p>
        
        <h3 class="text-xl font-medium mb-3">3.1 Information You Provide Directly</h3>
        <ul class="list-disc ml-6 space-y-2 mb-4">
          <li><span class="font-medium">Account Information:</span> Name, email address, phone number, and login details.</li>
          <li><span class="font-medium">Billing Information:</span> Payment details for subscriptions or purchases, processed through secure third-party payment providers.</li>
          <li><span class="font-medium">User Data Inputs:</span> Any data you upload for analysis and processing.</li>
        </ul>

        <h3 class="text-xl font-medium mb-3">3.2 Information We Collect Automatically</h3>
        <ul class="list-disc ml-6 space-y-2">
          <li><span class="font-medium">Usage Data:</span> Logs, timestamps, and activity records to improve service performance.</li>
          <li><span class="font-medium">Device & Connection Information:</span> IP address, browser type, and operating system.</li>
          <li><span class="font-medium">Cookies & Tracking Technologies:</span> We use cookies to enhance your experience and for analytics.</li>
        </ul>
      </section>

      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">4. How We Use Your Data</h2>
        <p class="mb-4">Fire AI processes your personal data to:</p>
        <ul class="list-disc ml-6 space-y-2">
        ...
        <p class="mt-4 font-medium">We do not sell your data to third parties.</p>
      </section>
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">6. Sharing of Personal Data</h2>
        <p class="mb-4">Fire AI may share your personal data only in the following cases:</p>
        <ul class="list-disc ml-6 space-y-2">
      ...
      <section class="mb-8">
        ...
        <p class="mb-4">Fire AI employs strict security measures to protect user data, including:</p>
        <ul class="list-disc ml-6 space-y-2">
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">8. Your Rights & Choices</h2>
        <p class="mb-4">Users have the right to:</p>
        <ul class="list-disc ml-6 space-y-2">
        ...
        <p class="mt-4">
          ...
          <a href="mailto:info@fireai.in" class="text-blue-600 hover:underline">
            info@fireai.in
          </a>
        </p>
      </section>
      ...
      <section class="mb-8">
        <h2 class="text-2xl font-semibold mb-4">9. Third-Party Integrations</h2>
        <p>
